...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    set_dish_ing = set(dish_ingredients)
    
    return (dish_name, set_dish_ing)
...
def tag_special_ingredients(dish):
    ...
    dish_name, dish_ingrediants = dish
        
    return dish_name, set(dish_ingrediants) & SPECIAL_INGREDIENTS
